...
class SermonAudioSlider extends StatefulWidget {
  const SermonAudioSlider({super.key});

  @override
  State<SermonAudioSlider> createState() => _SermonAudioSliderState();
}

class _SermonAudioSliderState extends State<SermonAudioSlider> {
  double? _dragValueMs;
